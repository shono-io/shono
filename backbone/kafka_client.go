...
func (k *kafkaBackbone) GetClient() (graph.BackboneClient, error) {
	var opts []kgo.Opt
...
func (k *kafkaClient) Produce(ctx context.Context, event graph.EventReference, key string, payload map[string]any) (err error) {
	var b []byte = nil
